...
import DogeswapLogo from '../assets/images/dogeswap-logo.png'
import FraxswapLogo from '../assets/images/fraxswap-logo.png'
import KibbleswapLogo from '../assets/images/kibbleswap-logo.png'
...
export const WETH_GNOSIS_ADDRESS = '0x0000000000000000000000000000000000000000'
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [DAI, USDC[ChainId.MAINNET], USDT[ChainId.MAINNET], WBTC[ChainId.MAINNET]],
  [ChainId.RINKEBY]: [],
  [ChainId.ARBITRUM_ONE]: [
    WETH[ChainId.ARBITRUM_ONE],
    WBTC[ChainId.ARBITRUM_ONE],
...
export const DEFAULT_TOKEN_LIST = `https://raw.githubusercontent.com/kensyone/swapr-fork-tokenlist/refs/heads/main/tokenlist/tokenlist.json`
...
export const NETWORK_DETAIL: { [chainId: number]: NetworkDetails } = {
  ...
  [ChainId.XDAI]: {
    ...
    chainName: 'Dogechain',
    nativeCurrency: {
      name: Currency.XDAI.name || 'WDOGE',
      symbol: Currency.XDAI.symbol || 'WDOGE',
...
export const RoutablePlatformKeysByNetwork = {
  [ChainId.MAINNET]: [RoutablePlatform.UNISWAP.name, UniswapV2RoutablePlatform.SUSHISWAP.name],
  [ChainId.ARBITRUM_ONE]: [RoutablePlatform.UNISWAP.name, UniswapV2RoutablePlatform.SUSHISWAP.name],
  [ChainId.XDAI]: [
...
export const ROUTABLE_PLATFORM_LOGO: { [routablePaltformName: string]: ReactNode } = {
  ...
  [UniswapV2RoutablePlatform.HONEYSWAP.name]: <img width={16} height={16} src={DogeswapLogo} alt="dogeswap" />,
  [UniswapV2RoutablePlatform.BAOSWAP.name]: <img width={16} height={16} src={KibbleswapLogo} alt="kibbleswap" />,
  [UniswapV2RoutablePlatform.LEVINSWAP.name]: <img width={16} height={16} src={FraxswapLogo} alt="fraxswap" />,

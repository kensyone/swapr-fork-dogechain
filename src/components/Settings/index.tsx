...
import { GitHub, Settings as SettingsIcon, Twitter, X } from 'react-feather'
...
const CODE_LINK = 'https://github.com/kensyone/swapr-fork-dogechain'
                ...
                {!simple && (
                  <>
                    ...
                    <RowBetween width="100%" marginTop="12px" marginBottom="12px">
                      ...
                      <MenuItem href="https://x.com/omnomtoken" data-testid="discord-hyperlink">
                        <Twitter size={14} />
                        Twitter
                      </MenuItem>
                    </RowBetween>
